...
> [!TIP]
> In case of errors or unexpected issues with Ansible, run the script with verbose flags (acceptable flags: -v, -vv, -vvv). Example:<br>
> ```bash -c "$(curl -Ls https://raw.githubusercontent.com/aiovin/lazy-vps/refs/heads/main/setup.sh)" -- -vvv```
...
- Displays the changes made by Ansible to the system during execution.
...
- Выводит изменения, вносимые Ansible в систему в процессе выполнения.
